...
fit <- sem(Figure6.3.model, data = table6.1_df)
...
fit.constrained.loadings <- sem(Figure6.3.model.constrained.loadings, data = table6.1_df)
summary(fit.constrained.loadings, standardized=TRUE)

anova(fit, fit.constrained.loadings)
...
fit.constrained.all <- sem(Figure6.3.model.constrained.all, data = table6.1_df)
anova(fit.constrained.loadings, fit.constrained.all)