...
### 2. Explain the four plotted graphs below
...
plot(g, vertex.size = degree(g, mode="in")*3, main = "Indegree")
plot(g, vertex.size = degree(g, mode="out")*5, main = "Outdegree")
plot(g, vertex.size = degree(g)*3, main = "All")
```

### 3. Explain the table below.  Compare to Table 11.2

Note. The closeness here is different from the closeness in the book.
...
### 4. Explain the correlations below.  Compare to p. 303

```{r message=FALSE}
kable(round(cor(Table11.2_df[, 2:4]), 3))

```

### 5. BONUS: Explain the numbers below
